    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 d-flex grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Info Biodata</h4>
        ...
        if ($foto != "") {
            ...
            if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
                ...
                if (!$query_input) {
                    ...
                    echo "<script>alert('Data berhasil ditambah.');window.location='infobiodata.php';</script>";
                }
            } else {
                //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='infobiodata.php';</script>";
            }
        } else {
            ...
            <div class="row">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Info Biodata</h4>
                            <p class="card-description"> Input Biodata </p>
