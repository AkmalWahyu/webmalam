...
function tambah($koneksi)
{
    if (isset($_POST['input_kategori'])) {
        ...
        if (!empty($kategori)) {
            ...
            //   "INSERT INTO kategori VALUES(md5('$id'),'$kategori')";
  ...
  <div class="main-panel">
      <div class="content-wrapper">
        <div class="row">
                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample" action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputNamel1" placeholder="Name" 
                            name="nama_kategori" value="" required>
                        </div>
            ...
            <!-- funtion menampilkan data di table -->
            <?php
