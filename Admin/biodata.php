                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" class="form-control" id="exampleInputName1" placeholder="Name" name="L" value="L" required>
                                    <label for="exampleInputName1">Perempuan</label>
                                    <input type="radio" class="form-control" id="exampleInputName1" placeholder="Name" name="P" value="P" required>
                                </div>
                                <div class="form-group">
