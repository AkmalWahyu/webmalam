    ...
    <div class="container">
        ...
        <nav class="navbar navbar-dark" style="background-color:142266">
            <a class="navbar-brand" href="#">
                ...
                <h1 style="color:red">WEB PENJUALAN BLK BANDA ACEH </h1>
            </a>
        </nav>
        <br>
        <div class="row">
            <div class="col-md-6">
                ...
                <form action="" method="POST">
                    <div class="form-group mb-2">
                        ...
                        pleceholder="masukkan jumlah data" name="jumlah">
                    </div>
                    <div class="form-group mb-2">
                    ...
                    <form action="" method="POST">
                        ...
                        for ($a = 1; $a <= $jumlah; $a++){
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" id="staticEmail2"
                                placeholder="Masukkan Nama Barang" name="nama_barang<?php echo!empty($a) ? $a : ''; ?>">
                            </div>
                            <div class="form-group mb-2">
                                <label for="inputPassword2">Harga Barang :</label>
                                <input type="number" class="form-control" id="inputPassword2"
                                value="0" placeholder="Harga Barang" name="harga<?php echo!empty($a) ? $a : ''; ?>">
                            </div>
                            <div class="form-group mb-2">
                                <label for="inputpassword2">Jumlah</label>
                                <input type="number" class="form-control" id="inputpassword2"
                                value="0" placeholder="JumlahBarang" name="jumlah<?php echo $a; ?>">
                            </div>
                        <?php
                        }
                        ?>
            ...
            if (isset($_POST['total'])) {
                ...
                <div class="col-md-6">
                    <div class="alert alert-primary" role="alert">
                        <?php echo " ". !empty($total_hasil) ? "Total Harga yang Harus dibayar Rp." . $total_hasil : '';
            } ?>        
                    </div>
                </div>
